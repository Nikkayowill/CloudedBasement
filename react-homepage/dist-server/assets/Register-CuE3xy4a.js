...
function Register() {
  ...
  return /* @__PURE__ */ jsx("div", { style: { minHeight: "100vh", width: "100vw", display: "flex", alignItems: "center", justifyContent: "center", background: "#09090b" }, children: /* @__PURE__ */ jsxs("div", { style: { width: "100%", maxWidth: "26rem", padding: "2rem 1.5rem", borderRadius: "0.75rem", background: "rgba(30,41,59,0.95)", boxShadow: "0 2px 24px 0 rgba(0,0,0,0.25)" }, children: [
    /* @__PURE__ */ jsxs("div", { className: "cb-title-row", style: { textAlign: "center", marginBottom: "2rem" }, children: [
