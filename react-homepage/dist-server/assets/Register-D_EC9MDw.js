...
function Register() {
  ...
  useEffect(() => {
    fetch("/api/csrf-token", { credentials: "include" }).then((r) => {
      ...
      setFetchError("Failed to load form. Please refresh.");
    });
    fetch("/api/auth/bot-challenge", { credentials: "include" }).then((r) => {
      if (!r.ok) throw new Error(`HTTP ${r.status}`);
      return r.json();
    }).then((d) => setBotCode(d.botCode)).catch((err) => {
      console.error("[Register] Bot challenge fetch failed:", err);
      setFetchError("Failed to load form. Please refresh.");
    });
  ...
  return /* @__PURE__ */ jsxs("div", { style: { minHeight: "100vh", position: "relative", overflow: "hidden", overflowX: "hidden", background: "#16171d" }, children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        "aria-hidden": "true",
    ...
    /* @__PURE__ */ jsx("div", { style: { width: "100%", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }, children: /* @__PURE__ */ jsxs("div", { style: { width: "100%", maxWidth: "24.5rem", background: "rgba(17, 24, 39, 0.84)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "0.9rem", padding: "1.75rem", boxShadow: "0 24px 70px rgba(0,0,0,0.45)", backdropFilter: "blur(6px)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", marginBottom: "1.25rem" }, children: [
        /* @__PURE__ */ jsx("p", { style: { fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#2DA7DF", margin: "0 0 0.375rem" }, children: "Get started free" }),
        /* @__PURE__ */ jsx("h1", { style: { fontSize: "1.5rem", fontWeight: 700, color: "#f5f5f5", margin: 0 }, children: "Create your account" })
      ] }),
      clientError && /* @__PURE__ */ jsx(Flash, { type: "error", children: clientError }),
      fetchError && /* @__PURE__ */ jsx(Flash, { type: "error", children: fetchError }),
      error && /* @__PURE__ */ jsx(Flash, { type: "error", children: error }),
      success && /* @__PURE__ */ jsx(Flash, { type: "success", children: success }),
      /* @__PURE__ */ jsxs("form", { method: "POST", action: "/register", onSubmit: handleSubmit, autoComplete: "off", children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "0.75rem" }, children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "reg-email", style: { display: "block", fontSize: "0.75rem", fontWeight: 500, color: "#9ca3af", marginBottom: "0.3rem" }, children: "Email" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "reg-email",
        ...
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "0.75rem" }, children: [
          /* @__PURE__ */ jsxs("label", { htmlFor: "reg-password", style: { display: "block", fontSize: "0.75rem", fontWeight: 500, color: "#9ca3af", marginBottom: "0.3rem" }, children: [
            "Password ",
        ...
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "0.875rem" }, children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "reg-confirm", style: { display: "block", fontSize: "0.75rem", fontWeight: 500, color: "#9ca3af", marginBottom: "0.3rem" }, children: "Confirm password" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "reg-confirm",
          ...
          form.confirmPassword && form.password !== form.confirmPassword && /* @__PURE__ */ jsx("div", { style: { color: "#fca5a5", fontSize: "0.75rem", marginTop: "0.25rem" }, children: "Passwords do not match." })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { marginBottom: "0.875rem", padding: "0.75rem", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "0.375rem" }, children: [
          /* @__PURE__ */ jsx("p", { style: { fontSize: "0.6875rem", color: "#6b7280", margin: "0 0 0.5rem" }, children: "Verify you are human — type the code exactly as shown" }),
          /* @__PURE__ */ jsx("div", { style: { textAlign: "center", padding: "0.5rem", background: "#0a0a0a", border: "1px solid rgba(45,167,223,0.2)", borderRadius: "0.25rem", marginBottom: "0.5rem" }, children: /* @__PURE__ */ jsx("span", { style: { fontFamily: "JetBrains Mono, monospace", fontSize: "1.125rem", fontWeight: 700, color: "#2DA7DF", letterSpacing: "0.3em" }, children: botCode || "······" }) }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
          ...
          botInput && !botCorrect && /* @__PURE__ */ jsx("div", { style: { color: "#fca5a5", fontSize: "0.75rem", marginTop: "0.25rem" }, children: "Bot code is incorrect." })
        ] }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: "0.5rem", marginBottom: "0.875rem" }, children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
        ...
        /* @__PURE__ */ jsx("button", { type: "submit", disabled: !submitReady, style: { width: "100%", padding: "0.5rem", background: submitReady ? "#2DA7DF" : "rgba(45,167,223,0.2)", border: "none", borderRadius: "0.375rem", color: submitReady ? "#fff" : "#6b7280", fontSize: "0.875rem", fontWeight: 600, cursor: submitReady ? "pointer" : "not-allowed", transition: "background 150ms, color 150ms", marginBottom: "1rem" }, children: "Create account" })
      ] }),
