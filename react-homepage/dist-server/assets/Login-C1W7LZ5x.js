...
function Login() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "funnel", children: [
    ...
    /* @__PURE__ */ jsx("main", { className: "pt-14", children: /* @__PURE__ */ jsx("section", { className: "funnel-section funnel-bg-solution", children: /* @__PURE__ */ jsx("div", { className: "funnel-prose", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto w-full", children: [
      /* @__PURE__ */ jsx("h1", { className: "funnel-heading-1 text-center mb-8", children: "Login" }),
      ...
      warning && /* @__PURE__ */ jsxs("div", { className: "bg-yellow-500/10 border border-yellow-500/30 text-yellow-300 px-4 py-2.5 rounded mb-5 text-sm flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 shrink-0", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { fillRule: "evenodd", d: "M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z", clipRule: "evenodd" }) }),
        warning
      ] }),
      ...
      showResend && /* @__PURE__ */ jsx("div", { className: "bg-blue-500/10 border border-blue-500/30 text-blue-300 px-4 py-2.5 rounded mb-5 text-sm", children: /* @__PURE__ */ jsx("a", { href: `/resend-confirmation?email=${encodeURIComponent(email)}`, className: "text-blue-400 hover:text-blue-300 underline", children: "Resend confirmation email" }) }),
      /* @__PURE__ */ jsxs("div", { className: "funnel-card-featured p-8", children: [
        /* @__PURE__ */ jsxs("form", { method: "POST", action: "/login", className: "space-y-5", children: [
          /* @__PURE__ */ jsx("input", { type: "hidden", name: "_csrf", value: csrf }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "login-email", className: "block funnel-body-sm font-medium mb-1.5", style: { color: "#d1d5db" }, children: "Email" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "login-email",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "login-password", className: "block funnel-body-sm font-medium mb-1.5", style: { color: "#d1d5db" }, children: "Password" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                id: "login-password",
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-5 text-center", children: /* @__PURE__ */ jsx("a", { href: "/forgot-password", className: "funnel-body-sm", style: { color: "#60a5fa" }, children: "Forgot password?" }) }),
        /* @__PURE__ */ jsxs("p", { className: "text-center funnel-body-sm mt-3", style: { color: "#9ca3af" }, children: [
          "Don't have an account?",
          " ",
          /* @__PURE__ */ jsx("a", { href: "/register", className: "text-blue-400 hover:text-blue-300 font-medium", children: "Register" })
        ] })
      ] })
    ] }) }) }) }),
    /* @__PURE__ */ jsx(Footer, {})
