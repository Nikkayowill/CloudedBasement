...
${getHTMLHead('Clouded Basement Hosting - Fast, Simple Cloud Hosting')}
    ...
    <section class="bg-black pt-32 pb-16">
      <div class="max-w-screen-xl px-8 md:px-12 lg:px-16 mx-auto text-center lg:px-12">
        ...
        <div class="flex flex-col mb-8 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <a href="/register" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-gray-900 bg-brand rounded-lg hover:bg-cyan-500 transition-all">
            Sign up
    ...
    <section class="bg-cyan-900/10 border-t border-cyan-500/10 py-16">
      <div class="max-w-screen-sm px-8 md:px-12 lg:px-16 mx-auto text-center sm:px-6 lg:px-8">
        ...
        <a href="/register" class="inline-flex justify-center items-center py-3 px-8 text-base font-medium text-gray-900 bg-cyan-400 rounded-lg hover:bg-cyan-500 focus:ring-4 focus:ring-cyan-300 transition-all">
          Sign up
